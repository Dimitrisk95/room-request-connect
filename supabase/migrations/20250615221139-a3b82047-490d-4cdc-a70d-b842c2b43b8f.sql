...
-- Drop ALL existing policies on users table (including the new ones from previous migration)
...
-- Create new, simple policies that avoid recursion with unique names
